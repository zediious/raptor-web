...
experience = "Please provide as much information as you can about any Admin roles you've had on Minecraft servers, whether you owned the server or were staff. Describe what exactly it was you did for the server you were staff of in as much detail as possible."
modpack_knowledge = "Administrating a modded server requires good knowledge of how mods play, to properly identify certain things. Have you played the modpacks we run on our network, and/or have a good understanding of how they/modded Minecraft in general works? Provide a short history of your time with Minecraft here as well."
plugin_knowledge = "Plugin/server-side mod knowledge is a necessity to become an Admin. Are there are any plugins in particular that you have extensive experience with? Do you believe that you can adapt to different configurations?"
