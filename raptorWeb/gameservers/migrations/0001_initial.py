    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discord_announcement_channel_id', models.CharField(default='0', max_length=200, verbose_name='Discord Announcement Channel ID')),
                ('discord_modpack_role_id', models.CharField(default='0', max_length=200, verbose_name='Discord Modpack Role ID')),
            ],
            options={
                'verbose_name': 'Server',
